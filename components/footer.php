<footer class="site-footer">
  ...
  <li><a href="#">Lower School (JK-Grade 6)</a></li>
  <li><a href="#">Upper School (Grades 7-12)</a></li>
  <li><a href="#">International Baccalaureate</a></li>
  ...
  <span class="footer-map-pill">VIEW MAP</span>
  </div>
  </div>
  </div>
  </div>
